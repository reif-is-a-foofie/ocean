...
class Moroni(AgentBase):
    ...
    def _generate_architecture(self, spec: ProjectSpec):
        ...
        # If Codex is unavailable and no API key, proceed with local fallback
        if spec.kind == "cli":
...
"""
        ...
        from .feed import agent_say as _say
        _say("Moroni", '"Architecture drafted (local fallback)."')
        return
...
'''
        ...
        from .feed import agent_say as _say
        _say("Q", '"Web backend scaffolded (local fallback)."')
...
'''
        ...
        from .feed import agent_say as _say
        _say("Q", '"Application backend scaffolded via Codex MCP."')
...
footer {{
    ...
    opacity: 0.8;
        ...
        from .feed import agent_say as _say
        _say("Edna", '"Interface designed (local fallback)."')
...
"""
        ...
        from .feed import agent_say as _say
        _say("Edna", '"Interface design documented."')
...
'''
        ...
        from .feed import agent_say as _say
        _say("Mario", '"Docker config generated (local fallback)."')
...
'''
        ...
        from .feed import agent_say as _say
        _say("Mario", '"Deployment config generated (local fallback)."')
